...
public class BricksTheme {
    ...
    public class ColorScheme {
        ...
        public ColorScheme primary(Color c) {
            this.primary = c;
            return this;
        }
        ...
        public ColorScheme onPrimary(Color c) {
            this.onPrimary = c;
            return this;
        }
        ...
        public ColorScheme primaryContainer(Color c) {
            this.primaryContainer = c;
            return this;
        }
        ...
        public ColorScheme onPrimaryContainer(Color c) {
            this.onPrimaryContainer = c;
            return this;
        }
        ...
        public ColorScheme secondary(Color c) {
            this.secondary = c;
            return this;
        }
        ...
        public ColorScheme onSecondary(Color c) {
            this.onSecondary = c;
            return this;
        }
        ...
        public ColorScheme secondaryContainer(Color c) {
            this.secondaryContainer = c;
            return this;
        }
        ...
        public ColorScheme onSecondaryContainer(Color c) {
            this.onSecondaryContainer = c;
            return this;
        }
        ...
        public ColorScheme tertiary(Color c) {
            this.tertiary = c;
            return this;
        }
        ...
        public ColorScheme onTertiary(Color c) {
            this.onTertiary = c;
            return this;
        }
        ...
        public ColorScheme tertiaryContainer(Color c) {
            this.tertiaryContainer = c;
            return this;
        }
        ...
        public ColorScheme onTertiaryContainer(Color c) {
            this.onTertiaryContainer = c;
            return this;
        }
        ...
        public ColorScheme error(Color c) {
            this.error = c;
            return this;
        }
        ...
        public ColorScheme onError(Color c) {
            this.onError = c;
            return this;
        }
        ...
        public ColorScheme errorContainer(Color c) {
        ...
        public ColorScheme onErrorContainer(Color c) {
            this.onErrorContainer = c;
            return this;
        }
        ...
        public ColorScheme background(Color c) {
            this.background = c;
            return this;
        }
        ...
        public ColorScheme onBackground(Color c) {
            this.onBackground = c;
            return this;
        }
        ...
        public ColorScheme surface(Color c) {
            this.surface = c;
            return this;
        }
        ...
        public ColorScheme onSurface(Color c) {
            this.onSurface = c;
            return this;
        }
        ...
        public ColorScheme surfaceVariant(Color c) {
            this.surfaceVariant = c;
            return this;
        }
        ...
        public ColorScheme onSurfaceVariant(Color c) {
            this.onSurfaceVariant = c;
            return this;
        }
        ...
        public ColorScheme surfaceContainer(Color c) {
        ...
        public ColorScheme surfaceContainerHigh(Color c) {
            this.surfaceContainerHigh = c;
            return this;
        }
        ...
        public ColorScheme surfaceContainerHighest(Color c) {
            this.surfaceContainerHighest = c;
            return this;
        }
        ...
        public ColorScheme outline(Color c) {
            this.outline = c;
            return this;
        }
        ...
        public ColorScheme outlineVariant(Color c) {
            this.outlineVariant = c;
            return this;
        }
        ...
        public ColorScheme inverseSurface(Color c) {
            this.inverseSurface = c;
            return this;
        }
        ...
        public ColorScheme inverseOnSurface(Color c) {
            this.inverseOnSurface = c;
            return this;
        }
        ...
        public ColorScheme inversePrimary(Color c) {
            this.inversePrimary = c;
            return this;
        }

        /** Volta ao {@link BricksTheme} pai para continuar o encadeamento. */
        public BricksTheme and() {
            return BricksTheme.this;
        }
    }
    ...
    public class Typography {
        ...
        public Typography fontFamily(String family) {
            this.fontFamily = family;
            return this;
        }

        /** @return tamanho do display grande (57pt) — para titulos de ecra */
        public double displayLarge() {
            return displayLarge;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography displayLarge(double size) {
            this.displayLarge = size;
            return this;
        }

        /** @return tamanho do display medio (45pt) */
        public double displayMedium() {
            return displayMedium;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography displayMedium(double size) {
            this.displayMedium = size;
            return this;
        }

        /** @return tamanho do display pequeno (36pt) */
        public double displaySmall() {
            return displaySmall;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography displaySmall(double size) {
            this.displaySmall = size;
            return this;
        }

        /** @return tamanho do headline grande (32pt) — para titulos de secao */
        public double headlineLarge() {
            return headlineLarge;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography headlineLarge(double size) {
            this.headlineLarge = size;
            return this;
        }

        /** @return tamanho do headline medio (28pt) */
        public double headlineMedium() {
            return headlineMedium;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography headlineMedium(double size) {
            this.headlineMedium = size;
            return this;
        }

        /** @return tamanho do headline pequeno (24pt) */
        public double headlineSmall() {
            return headlineSmall;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography headlineSmall(double size) {
            this.headlineSmall = size;
            return this;
        }

        /** @return tamanho do titulo grande (22pt) — para titulos de card/dialog */
        public double titleLarge() {
            return titleLarge;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography titleLarge(double size) {
            this.titleLarge = size;
            return this;
        }

        /** @return tamanho do titulo medio (16pt) */
        public double titleMedium() {
            return titleMedium;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography titleMedium(double size) {
            this.titleMedium = size;
            return this;
        }

        /** @return tamanho do titulo pequeno (14pt) */
        public double titleSmall() {
            return titleSmall;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography titleSmall(double size) {
            this.titleSmall = size;
            return this;
        }

        /** @return tamanho do corpo grande (16pt) — para texto de leitura principal */
        public double bodyLarge() {
            return bodyLarge;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography bodyLarge(double size) {
            this.bodyLarge = size;
            return this;
        }

        /** @return tamanho do corpo medio (14pt) — para texto de leitura secundario */
        public double bodyMedium() {
            return bodyMedium;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography bodyMedium(double size) {
            this.bodyMedium = size;
            return this;
        }

        /** @return tamanho do corpo pequeno (12pt) — para texto de apoio */
        public double bodySmall() {
            return bodySmall;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography bodySmall(double size) {
            this.bodySmall = size;
            return this;
        }

        /** @return tamanho do label grande (14pt) — para labels de botao */
        public double labelLarge() {
            return labelLarge;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography labelLarge(double size) {
            this.labelLarge = size;
            return this;
        }

        /** @return tamanho do label medio (12pt) */
        public double labelMedium() {
            return labelMedium;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography labelMedium(double size) {
            this.labelMedium = size;
            return this;
        }

        /** @return tamanho do label pequeno (11pt) */
        public double labelSmall() {
            return labelSmall;
        }

        /** @param size {@code double} — tamanho em pontos */
        public Typography labelSmall(double size) {
            this.labelSmall = size;
            return this;
        }
    ...
    public class Shapes {
        ...
        public Shapes extraSmall(double radius) {
            this.extraSmall = radius;
            return this;
        }
        ...
        /** @param radius {@code double} — raio dos cantos em pixels */
        public Shapes small(double radius) {
            this.small = radius;
            return this;
        }
        ...
        /** @param radius {@code double} — raio dos cantos em pixels */
        public Shapes medium(double radius) {
            this.medium = radius;
            return this;
        }
        ...
        /** @param radius {@code double} — raio dos cantos em pixels */
        public Shapes large(double radius) {
            this.large = radius;
            return this;
        }
        ...
        /** @param radius {@code double} — raio dos cantos em pixels */
        public Shapes extraLarge(double radius) {
            this.extraLarge = radius;
            return this;
        }
    ...
    public String toCss() {
        ...
        .list-view#list-view .list-cell:hover {
            -fx-background-color: %s;
            -fx-text-fill: %s;
        }
        .list-view#list-view .list-cell:selected,
        .list-view#list-view .list-cell:selected:hover {
            -fx-background-color: %s;
            -fx-text-fill: %s;
        }
        ...
        /* ---- MenuButton ---- */
        .menu-button.bricks-dropdown-menu {
            -fx-background-color: %s;
            -fx-text-fill: %s;
            -fx-font-size: %.0fpx;
            -fx-font-weight: bold;
            -fx-background-radius: %.0f;
            -fx-border-radius: %.0f;
            -fx-padding: 5 2.5 5 2.5;
            -fx-cursor: hand;
        }
        /* ---- DropdownMenu (MenuButton popup) ---- */
        .context-menu {
            -fx-background-color: %s;   /* surface */
            -fx-border-color: %s;       /* outline */
            -fx-border-radius: %s;      /* extraSmall */
            -fx-background-radius: %s;  /* extraSmall */
            -fx-padding: 4 0 4 0;
        }
        ...
        .context-menu .menu-item:hover {
            -fx-background-color: %s;   /* surfaceContainerHigh */
            -fx-background-radius: %s;  /* extraSmall */
        }
        /* ---- DataTableHeader ---- */
        .bricks-datatable-header {
        ...
        """.formatted(
                ...
                toHex(c.onSurface()),
                toHex(c.primaryContainer()),
                toHex(c.onPrimaryContainer()),
                // slider
                toHex(c.outlineVariant()),
                toHex(c.primary()),
                // progress-bar
                toHex(c.primary()),
                toHex(c.surfaceVariant()),
                // divider
                toHex(c.outlineVariant()),
                // menu-button
                toHex(c.primary()),
    ...
    private String layoutCss() {
        ...
        """,
            toHex(c.outlineVariant()),               // sidebar border
    ...
    public String toDataUri() {
        String encoded = URLEncoder.encode(toCss(), StandardCharsets.UTF_8).replace("+", "%20");
